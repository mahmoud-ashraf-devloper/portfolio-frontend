  ...
  return (
    <div id='about' className="max-w-[1240px] mx-auto w-full min-h-screen py-24  px-4 flex flex-col items-center">
      <div className="flex justify-self-start">
        <h2 className='w-full font-extrabold text-center text-transparent md:text-3xl text-2xl bg-clip-text bg-gradient-to-r from-[#709dff] to-[#5651e5] uppercase'>About</h2>
      </div>
      <div className=" md:grid grid-cols-4 gap-3 pt-4 h-full relative">
        <div className='bg-black/5 md:hidden absolute inset-0'></div>
        <div className="col-span-3 w-full h-full ">

          <h1 className='md:my-4 uppercase'>Who Am I?</h1>
          <p className='text-gray-800 my-2'>Hi, I am Mahmoud,</p>
          <div className='text-gray-800 text-md  leading-6'>
            ...
            <h2 className='text-lg flex items-center'><RiBookmarkFill className='text-indigo-600 mr-1 w-5 h-4' />Why Me?</h2>
            <ul className='ml-3'>
        ...
        <div className='overflow-hidden h-full pl-3  w-full flex absolute top-0'>
