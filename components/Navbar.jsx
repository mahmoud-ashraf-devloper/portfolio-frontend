            ...
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16 cursor-pointer'>
                ...
                <div>
                    <ul className='hidden md:flex space-x-10'>
                        <Link href='/'>
                            <li className='text-sm uppercase hover:text-[#5651e5] hover:font-bold ease-in duration-300 '>Home</li>
                        </Link>
                        <Link href='/#about'>
                            <li className='text-sm uppercase hover:text-[#5651e5] hover:font-bold ease-in duration-300 '>About</li>
                        </Link>
                        <Link href='/#skills'>
                            <li className='text-sm uppercase hover:text-[#5651e5] hover:font-bold ease-in duration-300 '>Skills</li>
                        </Link>
                        <Link href='/#projects'>
                            <li className='text-sm uppercase hover:text-[#5651e5] hover:font-bold ease-in duration-300 '>Projects</li>
                        </Link>
                        <Link href='/#contact'>
                            <li className='text-sm uppercase hover:text-[#5651e5] hover:font-bold ease-in duration-300 '>Contact</li>
                        </Link>
                    </ul>
